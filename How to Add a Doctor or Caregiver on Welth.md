...
+ _**NB:** The list only shows doctors or caregivers based on your condition. For example, if your default condition is rheumatoid athritis, the system only displays endocrinists._
...
<img width="250" alt="Chat page page with 'Share' circled" src="https://github.com/user-attachments/assets/02373b94-fba1-4548-8988-b4b367b4c478"/>
...
5. The system will share the data with the doctor or caregiver.
   ...
   + **Are all Health professionals accredited?** Yes. It is our top priority to ensure all health professionals are accredited. You can view our professional accreditation process [here](www.whoverify.com).
