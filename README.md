...
Welcome! This portfolio showcases a selection of my technical writing samples, with a focus on **clear communication**, **accessibility**, **UX/UI design**, **user-centered documentation**, and **structured formatting**. These works represent my initial projects following completion of the **Google Technical Writing** and **Board Infinity Technical Writing** courses. Aside the 2FA User Guide, the rest of the documents on this repo are for the fictional platforms Welth and Zendy. The real world solo project is in early development. Find it [here](https://github.com/Samuelsen1/Sample-2).
